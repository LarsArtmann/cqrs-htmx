...
require (
	...
	github.com/larsartmann/go-cqrs-lite/decider/v3 v3.7.4
	github.com/larsartmann/go-cqrs-lite/dedup/v3 v3.7.4
	...
	github.com/larsartmann/go-cqrs-lite/scenario/v3 v3.7.1
	github.com/larsartmann/go-cqrs-lite/stack/postgres/v3 v3.7.1
	...
	github.com/larsartmann/go-cqrs-lite/watermill/v3 v3.7.4
