...
func TestService_Register_DuplicateEmail(t *testing.T) {
	...
	_, _ = svc.Register(
		ctx,
		RegisterRequest{ID: NewUserID("u1"), Email: "a@b.com", Password: "password"},
	)
...
func TestService_Login(t *testing.T) {
	...
	_, _ = svc.Register(
		ctx,
		RegisterRequest{ID: NewUserID("user-1"), Email: "a@b.com", Password: "secret12"},
	)
...
func TestService_UpdateRoles(t *testing.T) {
	...
	if err := svc.UpdateRoles(ctx, NewUserID("user-1"), []string{RoleAdmin}, "user-1"); err != nil {
