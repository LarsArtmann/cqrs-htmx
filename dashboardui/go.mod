...
require (
	...
	github.com/larsartmann/templ-components/errorpage v1.19.0
	github.com/larsartmann/templ-components/htmx v1.19.0
	github.com/larsartmann/templ-components/icons v1.19.0
	github.com/larsartmann/templ-components/utils v1.19.0
)
