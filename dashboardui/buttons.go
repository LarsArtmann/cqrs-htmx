...
func buttonLink(ctx context.Context, text, href, ariaLabel string, variant display.ButtonType, disabled bool) string {
...
func buttonSubmit(ctx context.Context, text, ariaLabel string, variant display.ButtonType, attrs templ.Attributes) string {
	var b strings.Builder
