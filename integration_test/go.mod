...
require (
	...
	github.com/larsartmann/go-cqrs-lite/catalog/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/command/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/encryption/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/event/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/query/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/signing/v3 v3.7.0
