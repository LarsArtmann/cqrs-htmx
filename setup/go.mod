...
require (
	...
	github.com/larsartmann/go-appkit v0.2.0
...
// DEV-ONLY (remove before the next family tag): setup adopts
// *usermgmt.Service via Service.Journal()/EventBus() accessors added on the
