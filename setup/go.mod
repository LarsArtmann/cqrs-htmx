...
require (
	github.com/larsartmann/cqrs-htmx/adminui/v4 v4.11.0
	github.com/larsartmann/cqrs-htmx/dashboardui/v4 v4.11.0
	github.com/larsartmann/cqrs-htmx/datastar/v4 v4.11.0
	github.com/larsartmann/cqrs-htmx/identity-model/v4 v4.11.0
	github.com/larsartmann/cqrs-htmx/loginpage/v4 v4.11.0
...
// v4.8.1 and v4.8.2 are poisoned: v4.8.1 requires dashboardui/v4.8.1, whose tag
// predates SSEMaxReplay; v4.8.2's tag points at a commit whose go.mod fix was
// still uncommitted. Both are superseded by v4.8.3 (see AGENTS.md stale-tag
// protocol and CHANGELOG). Takes effect for consumers once a version carrying
// this directive is tagged.
retract (
	v4.8.2
	v4.8.1
)
