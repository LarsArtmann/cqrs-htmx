...
require (
	...
	github.com/larsartmann/go-cqrs-lite/idempotency/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/query/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/storage/memory/v3 v3.7.0
	github.com/larsartmann/go-cqrs-lite/transport/http/v3 v3.7.0
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/testutil/v3 v3.7.0 // indirect
