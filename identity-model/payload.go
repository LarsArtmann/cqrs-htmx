...
// applyUpcasters transforms legacy event payloads before decoding.
// Currently a no-op pass-through — add upcasters here as schema versions evolve.
func applyUpcasters(eventType event.Type, payload []byte) ([]byte, error) {
	return payload, nil
}
