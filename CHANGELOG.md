...
- **Coverage numbers updated**: Root 93.6% (gate 90%), openapi 99.0%, usermgmt 81.7% (gate 74%), identity-model 74.9% (gate 70%), dashboardui 82.1% (gate 60%). All 9 coverage gates pass.
