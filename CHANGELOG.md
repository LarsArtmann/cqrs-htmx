...
- **Coverage numbers updated with verified gate output**: Root 93.7% (gate 90%), openapi 99.0%, usermgmt 80.9% (gate 74%), identity-model 74.9% (gate 70%), dashboardui 72.5% (gate 60%). All 9 coverage gates pass.
