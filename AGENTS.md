...
- **`docs/guides/` contains 7 operational guides:** consistency-model, event-replay-and-rebuild, auth-provider-fault-tolerance, event-store-storage-health, event-catalog-guide, projection-health-monitoring, rebuild-projection-runbook. Reference these when answering questions about event sourcing operational concerns.
