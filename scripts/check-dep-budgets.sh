...
declare -A DEP_BUDGET=(
	...
	["setup"]=18            # setup: 16 current (cqrs-htmx family x6 [root/usermgmt/identity-model/adminui/dashboardui/loginpage], cqrs-lite event/id/projectionhost/storage-memory/watermill/eventtest, go-sse [direct since /sse replay], go-appkit [RunWithAppkit], error-family, httputil)
