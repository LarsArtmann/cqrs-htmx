...
declare -A DEP_BUDGET=(
  ...
  ["setup"]=19            # setup: 19 current (cqrs-htmx family x7 [root/usermgmt/identity-model/adminui/dashboardui/loginpage/datastar], cqrs-lite event/id/projectionhost/storage-memory/watermill/eventtest/storage, go-sse [direct since /sse replay], go-appkit [RunWithAppkit], error-family, httputil, modernc.org/sqlite [ADR-0050 wave]; go-cqrs-lite 2026-09-08 bump added 0 direct)
