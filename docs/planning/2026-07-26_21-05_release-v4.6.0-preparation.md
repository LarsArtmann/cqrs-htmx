...
**Not done:** v4.6.0 is **not yet tagged** (no `v4.6.0` / `*/v4.6.0` / `dashboardui/v4.1.0` tags exist). Tagging is deferred to the operator (`bash scripts/batch-release.sh`, then push). The SSE reconnect-replay work (`b98b2fa`, `62dada4`) landed _after_ this plan and is part of v4.6.0.
