...
**Not done (at time of writing):** ~~v4.6.0 is **not yet tagged** (no `v4.6.0` / `*/v4.6.0` / `dashboardui/v4.1.0` tags exist). Tagging is deferred to the operator (`bash scripts/batch-release.sh`, then push).~~ **Update 2026-07-31:** v4.6.0 and all sub-module tags (`adminui/v4.6.0`, `loginpage/v4.6.0`, `usermgmt/v4.6.0`, `dashboardui/v4.1.0`, etc.) were tagged on 2026-07-26. v4.6.1 followed on 2026-07-27. The SSE reconnect-replay work (`b98b2fa`, `62dada4`) landed _after_ this plan and is part of v4.6.0.
