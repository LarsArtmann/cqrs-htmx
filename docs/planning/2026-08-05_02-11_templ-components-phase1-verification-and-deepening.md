...
1-4 (above) +
5. Thread nonce through GlobalErrorHandling for CSP consumers
6. Update tailwind.css comment count ("8 .templ files" is now wrong if we add more)
7. Run `nix run .#lint` with a clean tree to verify adminui has 0 issues
