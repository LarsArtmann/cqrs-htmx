...
├── larsartmann/go-cqrs-lite/core v1.5.1-pre
├── larsartmann/go-error-family v0.1.1 (indirect)
...
| ---------------------- | ---------------------------------------------------------------------------- | ------------- |
| `go-cqrs-lite/core`    | app.go, authz.go, context.go, errors.go, handler.go, options.go, recovery.go | Production    |
| `justinas/nosurf`      | csrf.go, csrf_handler.go                                                     | Production    |
| `go-error-family`      | errors.go                                                                    | Production    |
| `larsartmann/httputil` | httputil.go                                                                  | Production    |
| `golang.org/x/time`    | ratelimit.go                                                                 | Production    |
| `casbin/casbin/v3`     | bdd_test.go, coverage_test.go, testing_test.go                               | **Test-only** |
...
| datastar-demo version mismatch     | ✅ Fixed | Migrated to v1.5.1 APIs (command.BasicCommand/query.BasicQuery)  |
| datastar-demo Go version           | ✅ Fixed | Upgraded to 1.26.3                                               |
| usermgmt version alignment         | ✅ Fixed | go-cqrs-lite → v1.5.1-pre, Go → 1.26.3, go-error-family → v0.1.1 |
