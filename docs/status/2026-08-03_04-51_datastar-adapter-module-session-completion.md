...
- Key design insight: ring buffer of *patches* is more correct than root's `JournalSSEStore` (which replays *events* and re-renders) — replays exactly what was broadcast
