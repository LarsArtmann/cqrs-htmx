...
| #   | Item                                                                                                                                                          | Why it matters                                                                                                                                                                                                                              |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | ~~**CHANGELOG.md entry** for binary removal~~ **done (2026-08-05)** — added to `[Unreleased]` Fixed: "Tracked binaries untracked (32 MB repo bloat removed)". | 32 MB repo bloat removed — notable enough for [Unreleased] Fixed section. **I forgot this entirely.**                                                                                                                                       |
...
| 3   | ~~**I didn't add a CHANGELOG entry**~~ **resolved (2026-08-05)** — the binary-removal entry is now in CHANGELOG `[Unreleased]` Fixed. | Low      | The fix is committed (`cf83e2da`) but CHANGELOG.md [Unreleased] has no record of it. The prior session's CHANGELOG entry mentions "all 7 examples migrated to httputil.NewServer" but doesn't note the binary that migration accidentally committed.                                                                                                                                                                    |
