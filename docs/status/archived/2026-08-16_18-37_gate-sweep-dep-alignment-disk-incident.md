...
> **ANNOTATED 2026-09-09 (docs-health):** its disk-incident workaround claim is obsolete ($HOME/.cache no longer works; current layout is /tmp via scripts/lib/go-cache-env.sh) and the mount is FULLY DEAD since 2026-08-22 (TODO_LIST P3). Routed 2026-09-09: tailwind-build fail-on-error, AGENTS replace-inventory lint, adoption-showcase remainder → ROADMAP residual/setup ideas. ARCHIVED.
## a) FULLY DONE
