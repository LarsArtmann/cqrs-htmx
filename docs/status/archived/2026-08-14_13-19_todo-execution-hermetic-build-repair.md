...
37. Deprecation audit: `event.MarkTombstone` in our test is upstream-deprecated — when go-cqrs-lite ships → routed: TODO_LIST Micro-debt bundle (upstream-gated, 2026-09-09).
