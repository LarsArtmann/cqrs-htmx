...
7. **CSRF hardening story** — `Mount` uses `httputil.CSRFConfig{}` (Secure=false), → routed: TODO_LIST P2 setup CSRF item (2026-09-09).
...
34. Make Run timeouts configurable (RunConfig or Config fields) → routed: ROADMAP setup surface ideas (2026-09-09).
...
41. Add troubleshooting section to setup README ("/" pitfall, conflict errors) → routed: TODO_LIST Docs debt (f) (2026-09-09).
