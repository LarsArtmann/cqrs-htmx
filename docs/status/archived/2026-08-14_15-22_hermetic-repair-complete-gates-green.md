...
21. Move `slowJournal` to a shared testutil if more drain-window tests appear. → routed: TODO_LIST Micro-debt (d) (2026-09-09).
...
31. systemadapter: persistent-checkpoint documentation in `docs/guides/leveraging-system-metaengine.md` → routed: ROADMAP residual micro-ideas (2026-09-09).
