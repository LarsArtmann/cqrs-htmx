...
| - | -------------------------------- | --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 | **M16 release train**            | setup-only train executed (v4.10.0)                                   | The _family-wide_ alignment (templ-components v1.13.2→v1.14.0, go-datastar v0.3.0→v0.5.0, otel v4.3.0→v4.4.0, go-health, go-health-dashboard, go-idempotency — 55 lag entries) is the NEXT train's list, deliberately deferred                           |
...
_Report based solely on the 2026-09-07 22:00–23:36 session (M9+M10+push+setup v4.10.0 train+Tier-4 briefing). Waiting for instructions._
