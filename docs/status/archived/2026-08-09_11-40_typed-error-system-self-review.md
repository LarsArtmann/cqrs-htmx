...
2. The usermgmt module has `usermgmt/http.go:314` with `_, _ = w.Write(buf.Bytes())` — same anti-pattern, uncaught → open: routed to TODO_LIST Micro-debt bundle (b) — still present at :315 (2026-09-09).
