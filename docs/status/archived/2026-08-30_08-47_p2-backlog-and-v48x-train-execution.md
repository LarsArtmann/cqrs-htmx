...
3. **CI release-train check is advisory only** (`|| true`). Blocking flip needs one green advisory week AND confirmation of repo visibility (see g1). Effort: S once unblocked. → routed: TODO_LIST P1 CI blocking flip — OVERDUE (2026-09-09).
