...
11. Extend `examples/samber-do-demo` or `setup-demo` to mount `auditlog.WithAuditLog` + `health.NewProbe` end-to-end. → routed: TODO_LIST Docs debt (e) (2026-09-09).
...
23. Websites for health + auditlog modules (website-launch pattern) once tagged. → routed: ROADMAP operational-ideas row (2026-09-09).
