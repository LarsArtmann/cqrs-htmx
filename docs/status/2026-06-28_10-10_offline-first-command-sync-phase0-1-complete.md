...
2. **No integration test wiring SSEEventStore + Broadcaster + ACK end-to-end.** Unit tests prove each piece works, but there's no test proving they work *together* in a real HTTP handler. This is the next highest-value test.
