...
- **Pagination** — `DecodePagination(r)` + `RenderPaginatedJSON[T]()` with go-cqrs-lite v3.0.0
...
| Dependency             | Purpose                                    |
| ---------------------- | ------------------------------------------ |
| go-cqrs-lite v3.0.0    | CQRS command/query dispatch, pagination    |
| casbin/casbin/v3       | Authorization                              |
| go-error-family v0.5.0 | Error classification                       |
