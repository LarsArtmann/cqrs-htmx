...
**Updated:** 2026-09-09 | **Version:** v4.9.0 family train (13 tags, 2026-09-01) + setup/v4.10.0 (2026-09-07) + go-cqrs-lite 2026-09-08-train bump (2026-09-09); train lag ZEROED by the 2026-09-09 alignment sweep (templ-components v1.16.0 family + 11 go-cqrs-lite minors); CI now enforces `--strict-lag 0` | **Lint:** 0 issues across 15 modules (2026-09-07 M9; v2.12.2 re-verified 2026-09-01) | **Coverage gates (all green; full run 2026-09-10):** root 93.2% (gate 90%), setup 86.3% (gate 80%), datastar 97.4% (gate 90%) — full table `nix run .#coverage-gate` | **`*Service` methods:** 73 (leading v5 indicator)
...
- **Coverage:** all 15 gates green (full table 2026-09-10: root 93.2%/90, usermgmt 81.9%/74, identity-model 75.5%/70, dashboardui 83.7%/60, setup 86.3%/80, systemadapter 89.9%/70, datastar 97.4%/90, health+auditlog 100%/90). Full per-module table: `nix run .#coverage-gate` (thresholds: root 90, usermgmt 74, identity-model 70, auth 80, adminui 66, loginpage 79, dashboardui 60, datastar 90, setup 80, systemadapter 70, health 90, auditlog 90). Race-safe.
