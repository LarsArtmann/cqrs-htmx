module github.com/larsartmann/cqrs-htmx/adminui/v3
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/stack/postgres/v3 v3.3.0 // indirect
	...
	github.com/larsartmann/go-cqrs-lite/storage/memory/v3 v3.3.0 // indirect
